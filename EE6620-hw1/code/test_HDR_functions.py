...
class Test_HDR_functions(unittest.TestCase):
    ...
    def test3_WhiteBalance(self):
        ...
        wb_test = WhiteBalance(src, y_range, x_range, case='red')
        mse = np.mean((golden - wb_test)**2)
        self.assertLessEqual(mse, 0.01)
        print("test3 mse is ", mse)
        return mse
